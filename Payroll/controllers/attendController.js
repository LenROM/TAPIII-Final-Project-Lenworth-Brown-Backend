...
export const updateAttendance = async(req, res, next) => {
    ...
    const sqlQuery = `UPDATE attendance SET EmployeeId = ?, AttendanceDate = ?, InTime = ?, OutTime = ?, IsFullDayy = ?
                    WHERE AttendanceId = ?`

    const [attendance, fields] = await pool.query([EmployeeId, AttendanceDate, InTime, OutTime, IsFullDay, id]);
